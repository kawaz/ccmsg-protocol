...
|---|---|---|---|---|
| 2026-09-10 | bug | open | [transcript-item-schema-static-type-and-item-identity](./2026-09-10-transcript-item-schema-static-type-and-item-identity.md) | TranscriptItem の Static 型消失と item 同一性 (uuid 重複) 不備 |
| 2026-09-10 | design | open | [rate-limited-error-code](./2026-09-10-rate-limited-error-code.md) | daemon 送出側 backpressure 用の rate_limited error code が契約に無い |
