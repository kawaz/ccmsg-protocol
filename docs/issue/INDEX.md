...
|---|---|---|---|---|
| 2026-09-11 | design | open | [unbounded-items-read-should-answer-the-tail](./2026-09-11-unbounded-items-read-should-answer-the-tail.md) | 境界の無い transcript_items_read は末尾を返す既定にするか |
